 ...
 * (PlaylistVault-2.0.6-x64.exe), so the URL changes with every release. This
...
const FALLBACK =
  'https://github.com/franklinalegu/playlistvault/releases/download/v2.0.6/PlaylistVault-2.0.6-x64.exe';
