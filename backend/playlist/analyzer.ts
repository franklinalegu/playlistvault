import type { PlaylistInfo, PlaylistVideo, VideoQuality } from '@shared/types';
 ...
 */
export function analyzePlaylist(rawUrl: string, quality: VideoQuality): AnalyzeHandle {
  ...
  const { promise: raw, kill } = runYtDlpCollect(buildAnalyzeArgs(parsed.normalized));
